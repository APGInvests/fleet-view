...
5. **Run the full suite:**
   ...
   ```
   Auto-loads every `fv_inv_*.js` group, prints `RESULT: PASS (774/774)` (count as of 2026-08-02) and refuses to clear the build on any failure. (Suite only, no preflight wrapper: `node tools/fv_smoke.js index.html tools/fv_inv_*.js`.)
