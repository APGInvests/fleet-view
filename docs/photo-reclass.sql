...
from units u where u.serial = '172B120067' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = '172B120067';
...
from units u where u.serial = '20141242' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = '20141242';
...
from units u where u.serial = '72B100178' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = '72B100178';
...
from units u where u.serial = '78C10202' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = '78C10202';
...
update units set photos = '[]'::jsonb, updated_at = now() where serial = '8802068';
...
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'C12532';
...
from units u where u.serial = 'D1970145' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'D1970145';
...
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'FQ08006';
...
from units u where u.serial = 'FQ08009' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'FQ08009';
...
from units u where u.serial = 'X5M00213' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'X5M00213';
...
from units u where u.serial = 'X5M00296' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'X5M00296';
...
from units u where u.serial = 'X5M00357' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'X5M00357';
...
from units u where u.serial = 'X5M00394' and coalesce(u.photos::text,'[]') <> '[]';
update units set photos = '[]'::jsonb, updated_at = now() where serial = 'X5M00394';
